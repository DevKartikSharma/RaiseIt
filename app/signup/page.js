        ...
        return <>
            <div className='w-full h-screen flex justify-center items-center '>
                <div className='flex flex-col bg-[rgba(95,95,95,0.1)] rounded-2xl justify-center items-center p-10'>
                    ...
                    <button className='bg-[rgb(34,40,55)] text-white px-12 py-3 h-fit rounded-lg hover:bg-[rgb(44,49,64)] w-fit' onClick={() => signOut({ callbackUrl: '/login' })}>Goto Login Page</button>
                </div>
            </div>
        </>
    }
        ...
        <div className=' flex flex-col  items-center min-h-screen gap-6 pt-36 select-none'>
            ...
            <div className='flex flex-col items-center'>
                <div className="inputs flex flex-col items-center gap-2">
                    <input type="email" placeholder='Email' className='border border-[rgb(55,65,81)] rounded px-4 py-2 h-10 w-72 bg-[rgba(36,43,53,0.65)] ' />
                    <button className='bg-[rgb(34,40,55)] text-white px-4 py-2 h-10 rounded-lg hover:bg-[rgb(44,49,64)] w-fit' onClick={() => signIn('google')}>Continue</button>
                </div>
                <div className="border-b border-[rgba(255,255,255,0.46)] w-[90%] m-6"></div>
                <div className="flex flex-col w-full gap-2">
                    <button
                        className="flex items-center border bg-white border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => signIn('google').then(() =>
                            router.push(session.user.isNewUser ? '/register' : '/verify'))}>
                    ...
                    <button
                        className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => signIn('github')}>
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg"
