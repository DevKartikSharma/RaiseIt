...
const Page = () => {
    ...
    return <>
        {
            session ? <div className=' flex flex-col  items-center min-h-screen select-none overflow-y-hidden'>
                    ...
                    <div className="flex flex-col gap-2 p-10 pt-5">
                        <div className="inputs flex flex-col items-center gap-4">
                            <div className="inputs w-[448px]  max-sm:w-[78vw] flex items-center flex-col">
                                ...
                                <div className="fields">
                                    <h2>Password</h2>
                                    <div className='flex items-center justify-between border hover:bg-[rgba(64,76,91,0.65)] border-[rgb(55,65,81)] rounded px-4 py-2 mb-2 w-full max-sm:w-[85vw] bg-[rgba(36,43,53,0.65)]'>
